...
export function InstructorsPage() {
  ...
  return (
    <>
      <style>{`
        .inst-root { font-family: 'DM Sans', sans-serif; }
        ...
        .inst-search { padding: 0.6rem 0.875rem; border: 1.5px solid #e5e7eb; border-radius: 8px; font-family: 'DM Sans', sans-serif; font-size: 0.85rem; outline: none; width: 260px; transition: border-color 0.15s; background: #ffffff; }
        ...
        .inst-table thead th { padding: 0.75rem 1.25rem; text-align: left; font-size: 0.72rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: #ffffff; background: #00563f; }
      ...
      <div className="inst-root">
        ...
        <div className="inst-card">
          {loading ? (
            <div className="inst-empty">Loading...</div>
          ) : filtered.length === 0 ? (
            <div className="inst-empty">
              {list.length === 0 ? "No instructors yet. Add your first instructor above." : "No instructors match your search."}
            </div>
          ) : (
      ...
      {showModal && (
        <InstructorFormModal
          ...
          onSuccess={() => { setShowModal(false); setEditInst(null); loadInstructors(); }}
        />
      )}
        ...
        <div className="modal-body">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="modal-footer">
              ...
              <button type="submit" className="btn-submit" disabled={saving}>{saving ? "Saving..." : instructor ? "Save Changes" : "Add Instructor"}</button>
            </div>
          </form>
        </div>
      </div>
