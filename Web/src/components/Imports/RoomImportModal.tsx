  ...
  return createPortal(
    <>
      <style>{`
        ...
        .rim-header { background: #1A5632; padding: 1.25rem 1.5rem; display: flex; align-items: flex-start; justify-content: space-between; border-radius: 12px 12px 0 0; }
        .rim-header h2 { font-family: 'Montserrat', 'Inter', sans-serif; font-size: 1.2rem; font-weight: 600; color: #ffffff; margin: 0 0 0.2rem 0; }
        ...
        .rim-drop-zone:hover, .rim-drop-zone.drag-over { border-color: #1A5632; background: rgba(26,86,50,0.04); }
        ...
        .rim-drop-zone h3 { font-family: 'Montserrat', 'Inter', sans-serif; font-size: 1.1rem; color: #0a1f14; margin: 0 0 0.5rem 0; }
        .rim-drop-zone p { font-size: 0.82rem; color: #9ca3af; margin: 0; font-weight: 300; }
        .rim-drop-zone .browse-link { color: #1A5632; font-weight: 500; text-decoration: underline; cursor: pointer; }
        .rim-actions-top { display: flex; justify-content: center; gap: 1rem; margin-top: 1.25rem; }
        .rim-btn-template { display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.5rem 1rem; background: #ffffff; color: #1A5632; border: 1.5px solid #c6e8d8; border-radius: 8px; font-family: 'Inter', sans-serif; font-size: 0.82rem; font-weight: 500; cursor: pointer; transition: background 0.15s; }
        ...
        .rim-stat.valid .rim-stat-value { color: #1A5632; }
        ...
        .rim-table thead th { padding: 0.6rem 0.75rem; text-align: left; font-size: 0.7rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.04em; color: #ffffff; background: #1A5632; border-bottom: 1px solid #004d38; white-space: nowrap; }
        ...
        .rim-btn-commit { padding: 0.6rem 1.5rem; background: #1A5632; color: #ffffff; border: none; border-radius: 8px; font-family: 'Inter', sans-serif; font-size: 0.85rem; font-weight: 500; cursor: pointer; transition: background 0.15s; }
        .rim-btn-commit:hover { background: #144425; }
        ...
        .rim-success h3 { font-family: 'Montserrat', 'Inter', sans-serif; font-size: 1.2rem; color: #0a1f14; margin: 0 0 0.5rem 0; }
        ...
        .rim-uploading-spinner { width: 40px; height: 40px; border: 3px solid #e5e2db; border-top-color: #1A5632; border-radius: 50%; margin: 0 auto 1rem; animation: rim-spin 0.8s linear infinite; }
      `}</style>
