        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SemesterLevel = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClinicalDays = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleSections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduleSections_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleSections_Sections_SectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleSections_ScheduleId",
                table: "ScheduleSections",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleSections_SectionId",
                table: "ScheduleSections",
                column: "SectionId");
